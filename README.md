...
**_NOTE:_ This is a read-only fork of nrminor/oneroof meant to record the state of the repo during the preparation of the manuscript Lail et al. 2024, _Sequencing RNA from pasteurized retail dairy enables genomic surveillance of H5N1 avian influenza in United States cattle_. If you would like to use the pipeline yourself for anything other than reproducing that study's findings, we recommend you use the actively maintained original repo at [nrminor/oneroof](https://github.com/nrminor/oneroof)**
